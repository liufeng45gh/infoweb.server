...
<link href="/css/sindex.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class=" fl_main fl_main_12" >
		...
		<div class="clear">
			<div class="search_element">
				<div  class="label h30">职位类别</div>
	                ...
	                <input   id="position_name" maxlength="18"  readonly value="${resume.position.name}" class="sel-text position_name" size="40"   placeholder="请选择">
			...
			<div class="search_element">
				...
				<div style="margin-left:125px;">
					<span>热门搜索： <a href="/resume">ios</a>
						<a href="/resume">java</a> 
						<a href="/resume">php</a> 
						<a href="/resume">android</a>
					</span>
				</div>
			</div>
		...
		<jsp:include page="indexInner.jsp"></jsp:include>
	</div>

            ...
            <div class="mainContainer">
                ...
                <div>
                    <div class="rightBody" style="margin-top:20px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="t-comment mt10">
                            <tbody>
                                <tr class="bg-blue height24">
                                    ...
                                    <td style="text-align:center">职位类别</td>
                                    <td style="text-align:center">发布城市</td>
                        ...
                        <a   class="simple_button" style="margin-top:20px;display:block;" href="/manage/recruitment/add">发布招聘信息</a>

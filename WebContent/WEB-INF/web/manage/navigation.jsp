...
<div class="vipnav" style="margin-top: 8px;">
    <div class="v-nav">
        <ul style="float: left;">
            ...
            <li id="top_nav_recruitment"><a href="/manage/job/list"><span>我的招聘</span></a></li>
            <li id="top_nav_service"><a href="/manage/service/list"><span>我的服务信息</span></a></li>
            <li id="top_nav_appeal"><a href="/manage/appeal/list"><span>我的求助</span></a></li>

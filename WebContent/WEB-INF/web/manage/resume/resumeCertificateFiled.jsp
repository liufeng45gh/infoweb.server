        ...
        <dl class="" style="z-index:900">
            ...
            <dd style="z-index:900">
                <div class="comName hasSel">
                    <input name="name" type="text" class="w302 wrongborder" value="${train.name }" data-validation="required">                     
                </div>                
            </dd>
        </dl>
        ...
        <dl class="" style="z-index:880">
            ...
            <dd class="timeSel" id="inpPos">
                <div class="yearSel linkage">
                    <input id="inpPosStartYear" name="date" class="w76 hasSetBox" value="<fmt:formatDate value="${train.date}" pattern="yyyy-MM-dd"/>" readonly="readonly" onClick="WdatePicker({el:'inpPosStartYear'})" data-validation="required">                    
                </div>                

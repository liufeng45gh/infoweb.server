                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="t-comment mt10">
                            <tbody>
                                <tr class="bg-blue height24">
                                 ...
                                 <tr>
                                     <td  style="text-align:center"><a href="/manage/interview/${interview.id}" target="_blank">${interview.job.title}</a>
                                         (正常显示)  
                                     </td>
                                     <td style="text-align:center"><fmt:formatDate value="${interview.job.updated_at}" pattern="yyyy-MM-dd HH:mm"/></td>
                                     <td style="text-align:center">${interview.job.company.name }</td>                                    
                                 </tr>
                                 </c:forEach>

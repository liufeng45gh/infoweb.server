            ...
            <div class="mainContainer">
                ...
                <div>
                    <div class="rightBody" style="margin-top:20px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="t-comment mt10">
                            <tbody>
                                <tr class="bg-blue height24">
                                 ...
                                 <c:forEach var="appeal" items="${userAppealList}" varStatus="status">
                                 <tr>
                                     <td style="text-align:center"><a href="#" target="_blank">${appeal.title}</a>
                                       
                                     </td>
                                     
                                     <td style="text-align:center">${appeal.businessType.name }</td>
                                     <td style="text-align:center">${appeal.parentCity.name }-${appeal.city.name }</td>
                                     
                                     <td style="text-align:center"><fmt:formatDate value="${appeal.updated_at}" pattern="yyyy-MM-dd HH:mm"/></td>
                                     <td style="text-align:center">
                                         <a href="/manage/appeal/update?id=${appeal.id }" target="_blank">修改</a>
                                         | <a href="javascript:refreshAppeal(${appeal.id });" class="js_auto_refresh_list" >刷新</a>    
                                         | <a href="javascript:deleteAppeal(${appeal.id });" class="js_auto_refresh_list" >删除</a>                                                                            
                                     </td>
                                 </tr>
                                 </c:forEach>
                        ...
                        <a   class="simple_button" style="margin-top:20px;display:block;" href="/manage/appeal/add_select">发布求助信息</a>

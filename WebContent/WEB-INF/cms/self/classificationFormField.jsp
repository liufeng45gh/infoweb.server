...
<tr>
	...
	<td><input id="city_name" type="text" class="easyui-textbox" name="name" value="<c:out value="${city.name}"/>" /><label id="city_name_info">* 分类名称</label></td>
</tr>
			
<tr>
	<th align="right">父级分类:</th>
	<td>
	<input id="parent_city" type="text" class="easyui-textbox" readonly="true" value="<c:out value="${parnetCity.name}"  />"  />

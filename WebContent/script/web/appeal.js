...
function workProvinceSelect(object){
	...
	$("#work_province_options").css("display","none");	
	//resetWorkCity();
	var redirect_url = "/appeal/"+$("#selected_type_id").val()+"?pcity_id="+$("#work_pcity_id").val();
...
function workCitySelect(object){
	...
	var redirect_url = "/appeal/"+$("#selected_type_id").val()+"?pcity_id="+$("#work_pcity_id").val()+"&city_id="+$("#work_city_id").val();
	window.location.href = redirect_url;
}
...
$(".type_select").click(function () {
	...
	var redirect_url = "/appeal/"+type_id+"?pcity_id="+$("#work_pcity_id").val()+"&city_id="+$("#work_city_id").val();
	window.location.href = redirect_url;
});
